        ...
        <div class="col-md-4">
            <p><strong>Additional Links</strong></p>
                <ul style="color: gray">
                    ...
                    {% endif %}
                    {% if publication.emd %}
                        <li>EMDB: <a href="http://www.ebi.ac.uk/pdbe/entry/emdb/{{publication.emdb}}">EMPIAR-{{publication.emdb}}</a></li>
                    {% else %}
                        <li>EMDBs: <a href="http://www.ebi.ac.uk/pdbe/entry/emdb/{{publication.emdb1}}">EMPIAR-{{publication.emdb1}}</a> <a href="http://www.ebi.ac.uk/pdbe/entry/emdb/{{publication.emdb2}}">EMPIAR-{{publication.emdb2}}</a> <a href="http://www.ebi.ac.uk/pdbe/entry/emdb/{{publication.emdb3}}">EMPIAR-{{publication.emdb3}}</a> <a href="http://www.ebi.ac.uk/pdbe/entry/emdb/{{publication.emdb4}}">EMPIAR-{{publication.emdb4}}</a> <a href="http://www.ebi.ac.uk/pdbe/entry/emdb/{{publication.emdb5}}">EMPIAR-{{publication.emdb5}}</a></li>
                    {% endif %}
